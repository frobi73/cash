...
-- Script date 2019. 07. 29. 15:03:50
...
--
ALTER TABLE products 
  ADD CONSTRAINT FK_products_product_ID FOREIGN KEY (product_ID)
...
--
CREATE TABLE not_available (
  not_avaible_ID INT(11) NOT NULL,
  product_ID INT(11) NOT NULL,
  start_date DATE NOT NULL,
  end_date DATE NOT NULL,
...
PROCEDURE GetAvailableResources(IN IName VARCHAR(255), IN IStartDate DATE, IN IEndDate DATE, IN ITown VARCHAR(255), IN IProductTypeId INT)
BEGIN
SELECT
  *
FROM products
  /*INNER JOIN product_types ON product_types.product_type_ID = products.product_type_id*/
  INNER JOIN companies
    ON products.company_id = companies.company_ID
  INNER JOIN town
    ON town.id = companies.town_Id
WHERE products.product_name = IName
AND town.Name = ITown
AND products.product_type_id = IProductTypeId
AND products.product_id NOT IN (SELECT
    products.product_id
  FROM not_available
    INNER JOIN products
