    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            const disableMouseEvents = () => {
                ...
                dragbox.css("border-color", "rgba(0, 204, 0, 1);");
            ...
            button.mouseenter(function onMouseEnter(event) { button.css("background", "rgba(0, 204, 0, 1);").css("color", "white"); }).mouseleave(function onMouseLeave() { button.css("background", "white").css("color", "rgba(0, 204, 0, 1);"); });
