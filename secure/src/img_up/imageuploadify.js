    ...
    $.fn.imageuploadify = function(opts) {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <span class='imageuploadify-message'> Húzd ide be a fájljaid</span>
          <button type="button" class="btn btn-default"> vagy válaszd ki őket a számítógpről</button>
        </div>
      </div>
      `);
          ...
          <div class='imageuploadify-details'>
            ...
            button.mouseenter(function onMouseEnter(event) {
                button.css("background", "rgba(0, 204, 0, 1)").css("color", "white");
            }).mouseleave(function onMouseLeave() {
                button.css("background", "white").css("color", "rgba(0, 204, 0, 1)");
            });
